<template>
  <pageComponent title="Dashboard">
    <div v-if="loading" class="flex justify-centre">Loading...</div>
    <div 
      v-else
      class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700"
    >
      <div 
        class="bg-white shadow-md p-3 animate-fade-down text-centre lg:order-2 flex flex-col order-1"
      ...
      <div class="bg-white shadow-md p-3 animate-fade-down text-centre lg:order-4 flex flex-col order-2"
      ...
      <div 
        class="bg-white shadow-md p-4 animate-fade-down row-span-2 lg:order-1 order-3"
      >
      ...
      <div 
        class="bg-white shadow-md p-3 animate-fade-down row-span-2 lg:order-3 order-4"
